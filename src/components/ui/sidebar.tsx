...
import EventidelogoBlack from '@/images/EventidelogoBlack.png'; // Replace with your logo path
      ...
      >
        ...
        >
          <svg
            ...
            className={`h-6 w-6 transform transition-transform ${isSidebarOpen ? 'rotate-180 flex justify-center' : ''}`}
            aria-hidden='true'
          >
          ...
          <nav className='-mx-3 space-y-2'>
            ...
            >
              ...
              >
                ...
                {isSidebarOpen && <span className='mx-2 text-md'>Trading</span>}
              </Link>
            </div>
            <div
              onClick={() => setState('5')}
            ...
            >
              ...
              >
                ...
                {isSidebarOpen && <span className='mx-2 text-md'>Support</span>}
              </Link>
            </div>
            <div className='text-slate-400 hover:bg-gray-100 hover:text-gray-700'>
              <a
                className={`flex mt-16 items-center rounded-lg px-3 py-2 ${!isSidebarOpen ? 'justify-center' : ''}`}
                href='#'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                ...
                {isSidebarOpen && <span className='mx-2 text-md'>Logout</span>}
              </a>
            </div>
          </nav>
        </div>
